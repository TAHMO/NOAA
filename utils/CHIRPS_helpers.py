...
def get_chirps_pentad_gee_progress(start_date, end_date, region=None, export_path="chirps_pentad.nc", daily_pentad=True):
    """
    Export CHIRPS pentad or daily data with tqdm progress bar (works in Google Colab).
    """
    # Choose dataset
    collection_id = "UCSB-CHG/CHIRPS/PENTAD" if daily_pentad else "UCSB-CHG/CHIRPS/DAILY"
    ...
    pbar = tqdm(total=n_images, desc="Exporting CHIRPS")
